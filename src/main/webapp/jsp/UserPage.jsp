	...
	<div>
		<table>
			...
			<tr>
				...
				<td>
					<form action="http://localhost:8080/PIZZERIA_FINAL/PizzaServletController" method="get">
						<input type="text" name="pizzaId" value="<%= pizza.getId() %>" style="display: none;">
						<input type="submit" value="Update">
					</form>
					
					<form action="http://localhost:8080/PIZZERIA_FINAL/UpdateAndDeletePizzaServletController" method="get">
						<input type="text" name="pizzaId" value="<%= pizza.getId() %>" style="display: none;">
						<input type="text" name="userId" value="<%= user.getId() %>" style="display: none;">
